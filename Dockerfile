...
WORKDIR /home/V2X-Hub/docker/
RUN chmod +x /home/V2X-Hub/docker/library.sh
RUN /home/V2X-Hub/docker/library.sh
RUN ldconfig
...
WORKDIR /home/V2X-Hub/docker/
RUN chmod +x /home/V2X-Hub/docker/database.sh
RUN /home/V2X-Hub/docker/database.sh
WORKDIR /home/V2X-Hub/docker/
RUN chmod +x /home/V2X-Hub/docker/service.sh
...
ENTRYPOINT ["/home/V2X-Hub/docker/service.sh"]
