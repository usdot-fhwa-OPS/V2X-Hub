## CI/CD Processes
| CI/CD |  Sonar Code Quality |
|----------------------|---------------------|
[![Build V2X-Hub Images and Run Integration Tests](https://github.com/usdot-fhwa-OPS/V2X-Hub/actions/workflows/ci.yml/badge.svg)](https://github.com/usdot-fhwa-OPS/V2X-Hub/actions/workflows/ci.yml) | [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=usdot-fhwa-ops_V2X-Hub&metric=alert_status)](https://sonarcloud.io/dashboard?id=usdot-fhwa-ops_V2X-Hub) |
# Overview
...
* Immediate Forward Plugin – Used to provide Immediate Forward message to V2X Hub RSU via RSU 4.1 specification or NTCIP 1218.
...
* JSON Message Logger Plugin – Logs all received and transmitted J2735 messages in daily rotating Tx and Rx log files 
* FLIR Camera Driver Plugin – Receives detection data from FLIR camera 
* CARMA Streets Plugin – An interface between V2X Hub and CARMA Streets
* Telematics Plugin – An interface between V2X Hub and Telematics 
...
Instructions for installing Docker may change, so please use the current instructions at the Docker website: https://docs.docker.com/install/linux/docker-ce/ubuntu/

### Install Docker compose
Instructions for installing Docker may change, so please use the current instructions at the Docker website: https://docs.docker.com/compose/install/

### Docker Hub repository 
Docker Hub repo for v2x-hub is located at: https://hub.docker.com/u/usdotfhwaops and includes multiple mutli-architecture images
> [!NOTE]
> V2X Hub docker images currently support **arm64** and **amd64** architectures

### Docker Image Build Paramters

**UBUNTU_VERSION** : Codename for ubuntu version to use as base image (Default: jammy)
**SKIP_PLUGINS** : Space separated list of plugins **NOT** to build (Default : "")
**J2735_VERSION**: SAE J2735 version number to use for V2X message set. (Default: 2024)

> [!NOTE]
>  **J2735_VERSION** supported currently are 2016, 2020 and 2024
