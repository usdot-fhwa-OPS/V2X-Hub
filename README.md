...
The Message Validation Tool was moved from the V2X-Hub repository to the new independent STOL repository: https://github.com/usdot-fhwa-stol/message-validation-tool
