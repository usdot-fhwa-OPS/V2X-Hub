...
CREATE TABLE `eventLog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 COMMENT='This table records events generated by every IVP core component and plugin in the IVP platform.  ';
...
INSERT INTO `messageActivity` VALUES (1,15,1,1,'2020-03-25 13:01:13',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=latin1 COMMENT='This table lists the plugins loaded and available to run on the IVP platform.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=latin1 COMMENT='This table lists the IVP system configuration parameters used by both core components and plugins to control the behavior of the system.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='This table identifies the types of messages generated by each plugin.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pluginStatus` VALUES (1,16,'','Running'),(2,16,'Number of Active Plugins','1'),(4,17,'','Running'),(5,18,'','Running'),(7,1,'','Running'),(10,1,'Start Time','2020-03-25 13:01:03.817');
...
INSERT INTO `user` VALUES (1,'','',3),(2,'Testing1!','Testing1!',3);
...
-- Dump completed on 2021-06-18 20:33:30
