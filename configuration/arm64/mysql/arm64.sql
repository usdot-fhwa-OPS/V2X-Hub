-- MariaDB dump 10.17  Distrib 10.4.8-MariaDB, for debian-linux-gnu (aarch64)
--
...
CREATE TABLE `eventLog` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1203 DEFAULT CHARSET=latin1 COMMENT='This table records events generated by every IVP core component and plugin in the IVP platform.  ';
...
INSERT INTO `eventLog` VALUES (1189,'------------------------','--------','2019-09-30 17:04:39','Debug',0),(1190,'IVP Core Starting','Ivp Core','2019-09-30 17:04:39','Info',0),(1191,'Plugin registered','ivpcore.PluginMonitor','2019-09-30 17:04:40','Info',0),(1192,'Plugin registered','ivpcore.MessageProfiler','2019-09-30 17:04:40','Info',0),(1193,'Plugin registered','ivpcore.HistoryManager','2019-09-30 17:04:41','Info',0),(1194,'Plugin registered','CommandPlugin','2019-09-30 17:04:57','Info',0),(1195,'Plugin \'CommandPlugin\' (id: 435) startup time: 1261 milliseconds','ivpcore.PluginMonitor','2019-09-30 17:05:01','Info',0),(1196,'------------------------','--------','2019-09-30 20:10:03','Debug',0),(1197,'IVP Core Starting','Ivp Core','2019-09-30 20:10:03','Info',0),(1198,'Plugin registered','ivpcore.PluginMonitor','2019-09-30 20:10:05','Info',0),(1199,'Plugin registered','ivpcore.MessageProfiler','2019-09-30 20:10:05','Info',0),(1200,'Plugin registered','ivpcore.HistoryManager','2019-09-30 20:10:05','Info',0),(1201,'Plugin registered','CommandPlugin','2019-09-30 20:10:22','Info',0),(1202,'Plugin \'CommandPlugin\' (id: 435) startup time: 1174 milliseconds','ivpcore.PluginMonitor','2019-09-30 20:10:26','Info',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=36621 DEFAULT CHARSET=latin1 COMMENT='This table records the most recent message activity of each active plugin in the IVP system. The data in this table is updated by the IVP plugin monitor core component for every message the plugin monitor receives.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `messageActivity` VALUES (31397,709,435,1,'2019-09-30 20:10:31',0);
...
) ENGINE=InnoDB AUTO_INCREMENT=724 DEFAULT CHARSET=latin1 COMMENT='This table lists the valid message types of every plugin loaded on the IVP platform.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `messageType` VALUES (695,'J2735','BSM','DSRC Basic Safety Message'),(696,'J2735','CSR','DSRC Common Safety Request'),(697,'J2735','EVA','DSRC Emergency Vehicle Alert'),(698,'J2735','IC','DSRC Intersection Collision'),(699,'J2735','MAP','DSRC Map Data'),(700,'J2735','NMEA','DSRC NMEA Corrections'),(701,'J2735','PDM','DSRC Probe Data Management'),(702,'J2735','PVD','DSRC Probe Vehicle Data'),(703,'J2735','RSA','DSRC Road Side Alert'),(704,'J2735','RTCM','DSRC RTCM Corrections'),(705,'J2735','SPAT','DSRC SPAT Message'),(706,'J2735','SRM','DSRC Signal Request Message'),(707,'J2735','SSM','DSRC Signal Status Message'),(708,'J2735','TIM','DSRC Traveler Information Message'),(709,'System','KeepAlive','');
...
) ENGINE=InnoDB AUTO_INCREMENT=458 DEFAULT CHARSET=latin1 COMMENT='This table lists the plugins loaded and available to run on the IVP platform.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plugin` VALUES (0,'Plugin System','The global configuration for all TMX plugins','4.0'),(435,'CommandPlugin','Listens for websocket connections from the TMX admin portal and processes commands','3.2.0'),(436,'CSW','Provides Curve Speed Warning (CSW).','3.2.0'),(437,'DynamicMessageSign','Provides communication to a dynamic message sign.','3.2.0'),(438,'DSRCMessageManager','Plugin that listens for TMX messages and forwards them to the DSRC Radio (i.e. the RSU).','3.2.0'),(439,'Location','Plugin used to send out Location Messages using data from GPSD','3.2.0'),(440,'MAP','Plugin that reads intersection geometry from a configuration file and publishes a J2735 MAP message.','3.2.0'),(441,'MessageReceiver','Plugin to receive messages from an external DSRC radio or other source','3.2.0'),(442,'ODEPlugin','Plugin to forward messages to the Florida ODEPlugin network','3.2.0'),(443,'RTCM','Plugin to listen for RTCM messages from an NTRIP caster and route those messages over DSRC','3.2.0'),(444,'SPAT','Plugin that reads PTLM data from a configuration file, receives live data from the signal controller, and publishes a J2735 SPAT message.','3.2.0'),(445,'Preemption','Preemption plugin for the IVP system.','3.0.0'),(446,'SPaTLoggerPlugin','Listens for SPaT messages and logs them in a file in CSV format.','3.2.0'),(447,'BsmLoggerPlugin','Listens for BSM messages and logs them in a file in CSV format.','3.2.0'),(448,'ivpcore.PluginMonitor','Core element that is responsible for starting/stopping installed plugins and monitoring the status of the plugins','3.2.0'),(449,'ivpcore.MessageProfiler','Core element that is responsible for profiling the statistics of received messages','3.2.0'),(450,'ivpcore.HistoryManager','Core element that is responsible for purging old log and history data','3.2.0');
...
) ENGINE=InnoDB AUTO_INCREMENT=1635 DEFAULT CHARSET=latin1 COMMENT='This table lists the IVP system configuration parameters used by both core components and plugins to control the behavior of the system.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=23396 DEFAULT CHARSET=latin1 COMMENT='This table identifies the types of messages generated by each plugin.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pluginMessageMap` VALUES (18172,435,709);
...
) ENGINE=InnoDB AUTO_INCREMENT=29675 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pluginStatus` VALUES (27521,448,'','Running'),(27522,448,'Number of Active Plugins','1'),(27524,449,'','Running'),(27525,450,'','Running'),(27527,435,'','Running'),(27530,435,'Start Time','2019-09-30 20:10:21.215');
...
CREATE TABLE `systemConfigurationParameter` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key` (`key`)
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=latin1 COMMENT='This table lists the IVP system configuration parameters used by both core components and plugins to control the behavior of the system.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `systemConfigurationParameter` VALUES (112,'LOG_FILE_NAME','ivpcore.log','ivpcore.log');
...
INSERT INTO `user` VALUES (2,'v2xadmin','V2xHub#321',3);
...
-- Dump completed on 2019-09-30 20:18:19
