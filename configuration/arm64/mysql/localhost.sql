...
) ENGINE=InnoDB AUTO_INCREMENT=448 DEFAULT CHARSET=latin1 COMMENT='This table lists the plugins loaded and available to run on the IVP platform.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `plugin` VALUES (435,'CommandPlugin','Listens for websocket connections from the TMX admin portal and processes commands','3.2.0'),(436,'CSW','Provides Curve Speed Warning (CSW).','3.2.0'),(437,'DynamicMessageSign','Provides communication to a dynamic message sign.','3.2.0'),(438,'DSRCMessageManager','Plugin that listens for TMX messages and forwards them to the DSRC Radio (i.e. the RSU).','3.2.0'),(439,'Location','Plugin used to send out Location Messages using data from GPSD','3.2.0'),(440,'MAP','Plugin that reads intersection geometry from a configuration file and publishes a J2735 MAP message.','3.2.0'),(441,'MessageReceiver','Plugin to receive messages from an external DSRC radio or other source','3.2.0'),(442,'ODEPlugin','Plugin to forward messages to the Florida ODEPlugin network','3.2.0'),(443,'RTCM','Plugin to listen for RTCM messages from an NTRIP caster and route those messages over DSRC','3.2.0'),(444,'SPAT','Plugin that reads PTLM data from a configuration file, receives live data from the signal controller, and publishes a J2735 SPAT message.','3.2.0'),(445,'Preemption','Preemption plugin for the IVP system.','3.0.0'),(446,'SPaTLoggerPlugin','Listens for SPaT messages and logs them in a file in CSV format.','3.2.0'),(447,'BsmLoggerPlugin','Listens for BSM messages and logs them in a file in CSV format.','3.2.0');
...
) ENGINE=InnoDB AUTO_INCREMENT=1609 DEFAULT CHARSET=latin1 COMMENT='This table lists the IVP system configuration parameters used by both core components and plugins to control the behavior of the system.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-10-08 14:14:34
