...
INSERT INTO `freight` VALUES ('RED-TRUCK','NULL',1.3,0.0,'ENTER_STAGING_AREA','one','two'),('RED-TRUCK','CARGO_A',-0.2,1.4,'PICKUP','two','three'),('RED-TRUCK','NULL',-0.2,-1.5,'DROPOFF','three','two');
UNLOCK TABLES;
