...
INSERT INTO `freight` VALUES ('RED-TRUCK','NULL',-0.2,-1.5,'ENTER_STAGING_AREA','one','two'),('RED-TRUCK','CARGO_A',1.3,0.0,'PICKUP','two','three'),('RED-TRUCK','CARGO_A',-1.7,0.0,'DROPOFF','three','two');
UNLOCK TABLES;
