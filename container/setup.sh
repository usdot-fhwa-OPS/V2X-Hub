...
chown plugin:www-data /var/www/plugins/.ssl
openssl req -x509 -newkey rsa:4096 -sha256 -nodes -keyout /var/www/plugins/.ssl/tmxcmd.key -out tmxcmd.crt -subj "/CN= <127.0.0.1> " -days 3650
chown plugin:www-data /var/www/plugins/.ssl/*
