...
/*
 * OAIContainerRequest.h
 *
 * 
 */

#ifndef OAIContainerRequest_H
#define OAIContainerRequest_H
...
class OAIContainerRequest : public OAIObject {
public:
    OAIContainerRequest();
    OAIContainerRequest(QString json);
    ~OAIContainerRequest() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIContainerRequest)

#endif // OAIContainerRequest_H
