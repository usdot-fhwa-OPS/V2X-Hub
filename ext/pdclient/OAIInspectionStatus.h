...
/*
 * OAIInspectionStatus.h
 *
 * 
 */

#ifndef OAIInspectionStatus_H
#define OAIInspectionStatus_H
...
class OAIInspectionStatus : public OAIObject {
public:
    OAIInspectionStatus();
    OAIInspectionStatus(QString json);
    ~OAIInspectionStatus() override;
...
Q_DECLARE_METATYPE(OpenAPI::OAIInspectionStatus)

#endif // OAIInspectionStatus_H
