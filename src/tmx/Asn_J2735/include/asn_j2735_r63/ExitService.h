...
/* Dependencies */
typedef enum ExitService__Memberitem_PR {
	ExitService__Memberitem_PR_NOTHING,	/* No components present */
	ExitService__Memberitem_PR_itis,
	ExitService__Memberitem_PR_text
} ExitService__Memberitem_PR;

/* Forward definitions */
typedef struct ExitService__Member {
	struct ExitService__Memberitem {
		ExitService__Memberitem_PR present;
