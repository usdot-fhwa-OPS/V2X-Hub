...
/* Dependencies */
typedef enum GenericSignage__Memberitem_PR {
	GenericSignage__Memberitem_PR_NOTHING,	/* No components present */
	GenericSignage__Memberitem_PR_itis,
	GenericSignage__Memberitem_PR_text
} GenericSignage__Memberitem_PR;

/* Forward definitions */
typedef struct GenericSignage__Member {
	struct GenericSignage__Memberitem {
		GenericSignage__Memberitem_PR present;
