...
/* Dependencies */
typedef enum ITIScodesAndText__Memberitem_PR {
	ITIScodesAndText__Memberitem_PR_NOTHING,	/* No components present */
	ITIScodesAndText__Memberitem_PR_itis,
	ITIScodesAndText__Memberitem_PR_text
} ITIScodesAndText__Memberitem_PR;

/* Forward definitions */
typedef struct ITIScodesAndText__Member {
	struct ITIScodesAndText__Memberitem {
		ITIScodesAndText__Memberitem_PR present;
