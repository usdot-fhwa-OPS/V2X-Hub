...
#ifndef	_RegionalExtension_BasicSafetyMessage_H_
#define	_RegionalExtension_BasicSafetyMessage_H_
...
/* RegionalExtension-BasicSafetyMessage */
...
#endif	/* _RegionalExtension_BasicSafetyMessage_H_ */
