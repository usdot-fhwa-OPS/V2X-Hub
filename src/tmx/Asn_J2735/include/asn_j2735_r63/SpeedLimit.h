...
/* Dependencies */
typedef enum SpeedLimit__Memberitem_PR {
	SpeedLimit__Memberitem_PR_NOTHING,	/* No components present */
	SpeedLimit__Memberitem_PR_itis,
	SpeedLimit__Memberitem_PR_text
} SpeedLimit__Memberitem_PR;

/* Forward definitions */
typedef struct SpeedLimit__Member {
	struct SpeedLimit__Memberitem {
		SpeedLimit__Memberitem_PR present;
