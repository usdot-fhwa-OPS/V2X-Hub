...
/* Dependencies */
typedef enum WorkZone__Memberitem_PR {
	WorkZone__Memberitem_PR_NOTHING,	/* No components present */
	WorkZone__Memberitem_PR_itis,
	WorkZone__Memberitem_PR_text
} WorkZone__Memberitem_PR;

/* Forward definitions */
typedef struct WorkZone__Member {
	struct WorkZone__Memberitem {
		WorkZone__Memberitem_PR present;
