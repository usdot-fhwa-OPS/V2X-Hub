...
asn_dec_rval_t
AntennaOffsetSet_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AntennaOffsetSet_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_AntennaOffsetSet_constr_1 GCC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_AntennaOffsetSet = {
	...
	AntennaOffsetSet_decode_uper,
	AntennaOffsetSet_encode_uper,
	...
	sizeof(asn_DEF_AntennaOffsetSet_tags_1)
		/sizeof(asn_DEF_AntennaOffsetSet_tags_1[0]), /* 1 */
	&asn_PER_type_AntennaOffsetSet_constr_1,
	0, 0,	/* No members */
	0	/* No specifics */
};
