...
asn_dec_rval_t
BSMblob_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
BSMblob_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_BSMblob_constr_1 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  38,  38 }	/* (SIZE(38..38)) */,
