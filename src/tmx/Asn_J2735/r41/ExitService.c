...
static asn_per_constraints_t asn_PER_type_item_es_constr_3 GCC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_item_es_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct item_es, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct item_es, choice.text),
...
static asn_TYPE_tag2member_t asn_MAP_item_es_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* itis */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* text */
};
static asn_CHOICE_specifics_t asn_SPC_item_es_specs_3 = {
	sizeof(struct item_es),
	offsetof(struct item_es, _asn_ctx),
	offsetof(struct item_es, present),
	sizeof(((struct item_es *)0)->present),
	asn_MAP_item_es_tag2el_3,
	2,	/* Count of tags in the map */
	0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_item_es_3 = {
	"item-es",
	"item-es",
	CHOICE_free,
	CHOICE_print,
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	&asn_PER_type_item_es_constr_3,
	asn_MBR_item_es_3,
	2,	/* Elements count */
	&asn_SPC_item_es_specs_3	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_Member_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ExitService__Member, item_es),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* item-es */
};
