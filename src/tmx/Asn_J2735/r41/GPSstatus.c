...
asn_dec_rval_t
GPSstatus_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
GPSstatus_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_GPSstatus = {
	...
	GPSstatus_decode_uper,
	GPSstatus_encode_uper,
