...
static asn_per_constraints_t asn_PER_memb_t1_constr_2 GCC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_t2_constr_4 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  1,  99 }	/* (1..99) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
