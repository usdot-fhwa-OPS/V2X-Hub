...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct GenericSignage__Memberitem, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct GenericSignage__Memberitem, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct GenericSignage__Memberitem),
	offsetof(struct GenericSignage__Memberitem, _asn_ctx),
	offsetof(struct GenericSignage__Memberitem, present),
	sizeof(((struct GenericSignage__Memberitem *)0)->present),
