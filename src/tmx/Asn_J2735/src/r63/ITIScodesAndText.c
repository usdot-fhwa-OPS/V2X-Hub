...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ITIScodesAndText__Memberitem, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ITIScodesAndText__Memberitem, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct ITIScodesAndText__Memberitem),
	offsetof(struct ITIScodesAndText__Memberitem, _asn_ctx),
	offsetof(struct ITIScodesAndText__Memberitem, present),
	sizeof(((struct ITIScodesAndText__Memberitem *)0)->present),
