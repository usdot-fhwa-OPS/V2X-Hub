...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SpeedLimit__Memberitem, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpeedLimit__Memberitem, choice.text),
...
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct SpeedLimit__Memberitem),
	offsetof(struct SpeedLimit__Memberitem, _asn_ctx),
	offsetof(struct SpeedLimit__Memberitem, present),
	sizeof(((struct SpeedLimit__Memberitem *)0)->present),
