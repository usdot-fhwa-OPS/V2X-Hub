...
static CONSTEXPR const char *MSGSUBTYPE_UNKNOWN_STRING = "Unknown";
...
constexpr std::array<std::pair<std::string_view, msgPSID>, 33> MSGTYPE_PSID_PAIRS = {{
	...
	{MSGSUBTYPE_MAPDATA_STRING, msgPSID::mapData_PSID},
	{MSGSUBTYPE_SIGNALPHASEANDTIMINGMESSAGE_STRING, msgPSID::signalPhaseAndTimingMessage_PSID},
	{MSGSUBTYPE_TRAFFICSIGNALPHASEANDTIMING_STRING, msgPSID::trafficSignalPhaseAndTiming_PSID},
	{MSGSUBTYPE_TRAFFICLIGHTSTATUSMESSAGE_STRING, msgPSID::trafficLightStatusMessage_PSID},
	{MSGSUBTYPE_SENSORDATASHARINGMESSAGE_STRING, msgPSID::sensorDataSharingMessage_PSID},
	{MSGSUBTYPE_MANEUVERSHARINGANDCOORDINATINGMESSAGE_STRING, msgPSID::maneuverSharingAndCoordinatingMessage_PSID},
	{MSGSUBTYPE_TRAVELERINFORMATION_STRING, msgPSID::travelerInformation_PSID},
	{MSGSUBTYPE_ROADSIDEALERT_STRING, msgPSID::roadSideAlert_PSID},
	{MSGSUBTYPE_ROADSAFETYMESSAGE_STRING, msgPSID::roadSafetyMessage_PSID},
	{MSGSUBTYPE_ROADWEATHERMESSAGE_STRING, msgPSID::roadWeatherMessage_PSID},
	{MSGSUBTYPE_ROADGEOMETRYANDATTRIBUTES_STRING, msgPSID::roadGeometryAndAttributes_PSID},
	{MSGSUBTYPE_EMERGENCYVEHICLEALERT_STRING, msgPSID::emergencyVehicleAlert_PSID},
	{MSGSUBTYPE_INTERSECTIONCOLLISION_STRING, msgPSID::intersectionCollision_PSID},
	{MSGSUBTYPE_COMMONSAFETYREQUEST_STRING, msgPSID::commonSafetyRequest_PSID},
	{MSGSUBTYPE_COOPERATIVECONTROLMESSAGE_STRING, msgPSID::cooperativeControlMessage_PSID},
	{MSGSUBTYPE_SIGNALREQUESTMESSAGE_STRING, msgPSID::signalRequestMessage_PSID},
	{MSGSUBTYPE_SIGNALSTATUSMESSAGE_STRING, msgPSID::signalStatusMessage_PSID},
	{MSGSUBTYPE_SIGNALCONTROLANDPRIORITIZATIONREQUEST_STRING, msgPSID::signalControlAndPrioritizationRequest_PSID},
	{MSGSUBTYPE_SIGNALCONTROLANDPRIORITIZATIONSTATUS_STRING, msgPSID::signalControlAndPrioritizationStatus_PSID},
	{MSGSUBTYPE_PROBEDATAMANAGEMENT_STRING, msgPSID::probeDataManagement_PSID},
	{MSGSUBTYPE_PROBEVEHICLEDATA_STRING, msgPSID::probeVehicleData_PSID},
	{MSGSUBTYPE_PROBEDATACONFIGMESSAGE_STRING, msgPSID::probeDataConfigMessage_PSID},
	{MSGSUBTYPE_PROBEDATAREPORTMESSAGE_STRING, msgPSID::probeDataReportMessage_PSID},
	{MSGSUBTYPE_TOLLADVERTISEMENTMESSAGE_STRING, msgPSID::tollAdvertisementMessage_PSID},
	{MSGSUBTYPE_TOLLUSAGEMESSAGE_STRING, msgPSID::tollUsageMessage_PSID},
	{MSGSUBTYPE_TOLLUSAGEACKMESSAGE_STRING, msgPSID::tollUsageAckMessage_PSID},
	{MSGSUBTYPE_ROADUSERCHARGINGCONFIGMESSAGE_STRING, msgPSID::roadUserChargingConfigMessage_PSID},
