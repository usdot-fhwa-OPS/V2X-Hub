...
namespace tmx::utils::rsu::mib::ntcip1218
{
    ...
    static constexpr const char *rsuIDOid = "1.3.6.1.4.1.1206.4.2.18.13.4.0";

    // RSU MIB Version. Contains the version of this MIB supported by this RSU, e.g. rsuMIB 4.1 rev201812060000Z
    static constexpr const char *rsuMibVersionOid = "1.3.6.1.4.1.1206.4.2.18.13.1.0";

    // RSU Firmware Version. Contains the version of firmware running on this RSU.
    static constexpr const char *rsuFirmwareVersionOid = "1.3.6.1.4.1.1206.4.2.18.13.2.0";
    ...
    static constexpr const char *rsuIFMIndexOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.1.0";
    ...
    static constexpr const char *rsuIFMPsidOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.2.0";
    ...
    static constexpr const char *rsuIFMTxChannelOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.3.0";

    // Forward Message Enable. Set this bit to enable transmission of the message. 1 is to enable transmission.
    static constexpr const char *rsuIFMEnableOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.4.0";

    // Forward Message Status. Create (4) or Destroy (6) row entry
    static constexpr const char *rsuIFMStatusOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.5.0";
    ...
    static constexpr const char *rsuIFMPriorityOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.6.0";
    ...
    */
    static constexpr const char *rsuIFMOptionsOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.7.0";

    // Forward Message Payload. Payload of Immediate Forward message.
    static constexpr const char *rsuIFMPayloadOid = "1.3.6.1.4.1.1206.4.2.18.4.2.1.8.0";   
    ...
    */
    static constexpr const char *rsuChanStatusOid = "1.3.6.1.4.1.1206.4.2.18.16.1.0";
    ...
    static constexpr const char *rsuModeOid = "1.3.6.1.4.1.1.1206.4.2.18.16.2.0";
}
