...
namespace CARMAStreetsPlugin
{
    ...
    public:
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2Spat(const Json::Value spat_json, SPAT *spat) const;
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2IntersectionStateList(const Json::Value intersections_json, IntersectionStateList *intersections) const;
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2MovementList(const Json::Value movements_json, MovementList *states) const;
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2MovementEventList(const Json::Value movement_events_json, MovementEventList *state_time_speed) const;
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2TimeChangeDetail(const Json::Value time_change_detail_json, TimeChangeDetails_t *timing) const;
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2ManeuverAssistList(const Json::Value maneuver_assist_list_json, ManeuverAssistList *maneuver_assist_list) const;
         ...
         * @return true: Conversion success, false otherwise
         */
        bool convertJson2AdvisorySpeed(Json::Value speeds_json, AdvisorySpeedList_t *speeds) const;
         ...
         */
        bool encodeSpat(tmx::messages::SpatMessage &spat_message, tmx::messages::SpatEncodedMessage &encodedSpat) const;
