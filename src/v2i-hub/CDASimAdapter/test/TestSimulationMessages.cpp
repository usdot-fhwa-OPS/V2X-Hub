...
TEST(SimulationMessages, SensorDetectedObjectToRoutableMessage)
{
    simulation::SensorDetectedObject externalObj;
    ...
    tmx::utils::sim::SimulationSensorDetectedObjectConverter::jsonToSimExternalObj(expectedStr, externalObj);
    ASSERT_EQ("SensorDetectedObject", std::string(simulation::SensorDetectedObject::MessageSubType));
    ASSERT_EQ("Application", std::string(simulation::SensorDetectedObject::MessageType));
    ...
    ASSERT_EQ("SensorDetectedObject",routeableMsg.get_subtype());
    ASSERT_EQ("Application", routeableMsg.get_type());
}