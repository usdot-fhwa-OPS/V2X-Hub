# Install script for directory: /home/saxtonlab/V2X-Hub/src/v2i-hub/DmsPlugin
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xdmspluginx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/DynamicMessageSign/bin" TYPE EXECUTABLE PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ GROUP_EXECUTE GROUP_READ WORLD_EXECUTE WORLD_READ FILES "/home/saxtonlab/V2X-Hub/src/v2i-hub/bin/DmsPlugin")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/DynamicMessageSign/bin/DmsPlugin" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/DynamicMessageSign/bin/DmsPlugin")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/DynamicMessageSign/bin/DmsPlugin"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xdmspluginx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/DynamicMessageSign" TYPE FILE PERMISSIONS OWNER_WRITE OWNER_READ GROUP_READ WORLD_READ FILES "/home/saxtonlab/V2X-Hub/src/v2i-hub/DmsPlugin/manifest.json")
endif()
