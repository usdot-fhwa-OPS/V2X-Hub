...
namespace ERVCloudForwardingPlugin
{
    ...
    public:
         ...
         * @return Hex string
         */
        static std::string encodeBSMHex(BsmMessage &msg);
        /**
         ...
         */
        static std::map<long, long> ParseGPS(const std::string &gps_nmea_data);
        /**
         ...
         */
        static std::string constructRSULocationRequest(std::string &rsu_identifier, uint16_t v2xhub_web_port, long latitude, long longitude);
    };
}
#endif