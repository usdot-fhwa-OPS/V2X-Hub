...
namespace ImmediateForward {
     ...
     */
    std::unordered_map<std::string, unsigned int> initializeImmediateForwardTable( tmx::utils::snmp_client* const client, const std::vector<MessageConfig> &messageConfigs);
