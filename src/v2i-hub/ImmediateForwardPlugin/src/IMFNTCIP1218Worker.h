...
namespace ImmediateForward {
     ...
     * before transmitting. Used when forwarding a raw SPDU, whose PSID comes from the message
     * itself rather than from the configuration the row was initialized with. When unset the row
     * keeps the PSID it was initialized with.
     */
