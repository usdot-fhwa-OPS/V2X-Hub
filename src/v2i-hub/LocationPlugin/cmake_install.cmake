# Install script for directory: /home/saxtonlab/V2X-Hub/src/v2i-hub/LocationPlugin
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xlocationpluginx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/Location/bin" TYPE EXECUTABLE PERMISSIONS OWNER_EXECUTE OWNER_WRITE OWNER_READ GROUP_EXECUTE GROUP_READ WORLD_EXECUTE WORLD_READ FILES "/home/saxtonlab/V2X-Hub/src/v2i-hub/bin/LocationPlugin")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/Location/bin/LocationPlugin" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/Location/bin/LocationPlugin")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/Location/bin/LocationPlugin"
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xlocationpluginx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/Location" TYPE FILE PERMISSIONS OWNER_WRITE OWNER_READ GROUP_READ WORLD_READ FILES "/home/saxtonlab/V2X-Hub/src/v2i-hub/LocationPlugin/manifest.json")
endif()
