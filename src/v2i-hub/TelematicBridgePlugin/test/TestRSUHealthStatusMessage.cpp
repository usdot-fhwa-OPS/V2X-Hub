...
{
    RSUHealthStatusMessage msg("192.168.1.1", 161, "operate", "startup");
    
    EXPECT_EQ("192.168.1.1", msg.getIp());
    EXPECT_EQ(161, msg.getPort());
    EXPECT_EQ("operate", msg.getStatus());
}
...
TEST(TestRSUHealthStatusMessage, ToString)
{
    ...
    EXPECT_EQ("operate", root["status"].asString());
...
{
    RSUHealthStatusMessage msg1("192.168.1.1", 161, "operate", "startup");
    RSUHealthStatusMessage msg2("192.168.1.1", 161, "operate", "startup");
    RSUHealthStatusMessage msg3("192.168.1.2", 161, "operate", "startup");
...
{
    RSUHealthStatusMessage msg1("192.168.1.1", 161, "operate", "startup");
    RSUHealthStatusMessage msg2("192.168.1.1", 1610, "operate", "startup");
